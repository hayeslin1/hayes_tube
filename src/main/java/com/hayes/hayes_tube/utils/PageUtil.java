...
public class PageUtil<T> {
    ...
    public PageUtil(int pageNumber, int limit, int total, List<T> list) {
        init(list, pageNumber, limit, total);
    }

    private void init(List<T> list, int pageNumber, int limit, int total) {
        //设置基本参数
        this.list = list;
        this.total = total;
        this.limit = limit;
